...
#define TSK_STACK_CANARY 1464 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 2816 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 3904 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 3800 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 3880 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 3896 /* offsetof(struct task_struct, thread.mte_ctrl) */
...
#define VCPU_FAULT_DISR 2152 /* offsetof(struct kvm_vcpu, arch.fault.disr_el1) */
#define VCPU_HCR_EL2 2096 /* offsetof(struct kvm_vcpu, arch.hcr_el2) */
