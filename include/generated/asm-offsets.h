...
#define TSK_ACTIVE_MM 1448 /* offsetof(struct task_struct, active_mm) */
...
#define TSK_STACK_CANARY 1592 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 3680 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 4768 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 4672 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 4752 /* offsetof(struct task_struct, thread.keys_kernel) */
...
#define MM_CONTEXT_ID 760 /* offsetof(struct mm_struct, context.id.counter) */
...
#define VCPU_HCR_EL2 2112 /* offsetof(struct kvm_vcpu, arch.hcr_el2) */
#define CPU_USER_PT_REGS 0 /* offsetof(struct kvm_cpu_context, regs) */
#define CPU_RGSR_EL1 1752 /* offsetof(struct kvm_cpu_context, sys_regs[RGSR_EL1]) */
#define CPU_GCR_EL1 1760 /* offsetof(struct kvm_cpu_context, sys_regs[GCR_EL1]) */
...
#define HOST_CONTEXT_VCPU 1816 /* offsetof(struct kvm_cpu_context, __hyp_running_vcpu) */
...
#define NVHE_INIT_HFGWTR_EL2 56 /* offsetof(struct kvm_nvhe_init_params, hfgwtr_el2) */
#define NVHE_INIT_VTTBR 64 /* offsetof(struct kvm_nvhe_init_params, vttbr) */
#define NVHE_INIT_VTCR 72 /* offsetof(struct kvm_nvhe_init_params, vtcr) */
...
#define TRAMP_VALIAS -8627707904 /* TRAMP_VALIAS */
