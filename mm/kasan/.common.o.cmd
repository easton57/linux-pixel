...
deps_mm/kasan/common.o := \
  ...
  mm/kasan/kasan.h \
    $(wildcard include/config/KASAN_KUNIT_TEST) \
    $(wildcard include/config/KASAN_OUTLINE) \
    $(wildcard include/config/KASAN_MODULE_TEST) \
...
mm/kasan/common.o: $(deps_mm/kasan/common.o)

$(deps_mm/kasan/common.o):
#SYMVER __kasan_kmalloc 0x363da5ff
