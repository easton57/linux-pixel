...
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:36:   DEFINE(TSK_TI_TTBR0,		offsetof(struct task_struct, thread_info.ttbr0));
// 36 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->TSK_TI_TTBR0 8 offsetof(struct task_struct, thread_info.ttbr0)"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:39:   DEFINE(TSK_TI_SCS_BASE,	offsetof(struct task_struct, thread_info.scs_base));
// 39 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->TSK_TI_SCS_BASE 24 offsetof(struct task_struct, thread_info.scs_base)"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:40:   DEFINE(TSK_TI_SCS_SP,		offsetof(struct task_struct, thread_info.scs_sp));
...
.ascii "->TSK_STACK_CANARY 1464 offsetof(struct task_struct, stack_canary)"	//
// 0 "" 2
...
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:113:   DEFINE(VCPU_FAULT_DISR,	offsetof(struct kvm_vcpu, arch.fault.disr_el1));
// 113 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->VCPU_FAULT_DISR 2152 offsetof(struct kvm_vcpu, arch.fault.disr_el1)"	//
// 0 "" 2
...
.ascii "->VCPU_HCR_EL2 2096 offsetof(struct kvm_vcpu, arch.hcr_el2)"	//
// 0 "" 2
