...
$(deps_fs/locks.o):
#SYMVER locks_alloc_lock 0xe9e62130
#SYMVER locks_release_private 0xa881985e
#SYMVER locks_owner_has_blockers 0x45a25ee5
#SYMVER locks_free_lock 0x6922170d
#SYMVER locks_init_lock 0x5086951a
#SYMVER locks_copy_conflock 0xbb9f3615
#SYMVER locks_copy_lock 0xce405d22
#SYMVER locks_delete_block 0xab839892
#SYMVER posix_test_lock 0x95a2f033
#SYMVER posix_lock_file 0x431075a8
#SYMVER lease_modify 0x6e5938d2
#SYMVER __break_lease 0xe630927e
#SYMVER lease_get_mtime 0x7dea3483
#SYMVER generic_setlease 0x98bd96d0
#SYMVER lease_register_notifier 0x43aa319e
#SYMVER lease_unregister_notifier 0x985453e1
#SYMVER vfs_setlease 0x1781de66
#SYMVER locks_lock_inode_wait 0x042e0308
#SYMVER vfs_test_lock 0xdb66f5a6
#SYMVER vfs_lock_file 0xe2e45c38
#SYMVER locks_remove_posix 0x1adc0448
#SYMVER vfs_cancel_lock 0x6ffb93aa
#SYMVER vfs_inode_has_locks 0x3b7f64ac
