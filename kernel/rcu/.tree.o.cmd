...
$(deps_kernel/rcu/tree.o):
#SYMVER rcu_scheduler_active 0x42825ce2
#SYMVER rcu_get_gp_kthreads_prio 0x216de4e1
#SYMVER rcu_momentary_dyntick_idle 0x5a1d134a
#SYMVER rcu_get_gp_seq 0xe6e40502
#SYMVER rcu_exp_batches_completed 0x6d7e951e
#SYMVER rcutorture_get_gp_data 0x2e028ae6
#SYMVER rcu_is_watching 0xce6db656
#SYMVER rcu_gp_slow_register 0xbb028ad3
#SYMVER rcu_gp_slow_unregister 0x7f84f35d
#SYMVER rcu_gp_set_torture_wait 0xb2c1732e
#SYMVER rcu_force_quiescent_state 0x8924eb1e
#SYMVER call_rcu 0x28aa6a67
#SYMVER kvfree_call_rcu 0xbaf22757
#SYMVER synchronize_rcu 0x6091797f
#SYMVER get_completed_synchronize_rcu_full 0x61bd0bd0
#SYMVER get_state_synchronize_rcu 0xf3808cb1
#SYMVER get_state_synchronize_rcu_full 0x67c3c795
#SYMVER start_poll_synchronize_rcu 0x91955a9f
#SYMVER start_poll_synchronize_rcu_full 0xb23b7691
#SYMVER poll_state_synchronize_rcu 0x442deaa9
#SYMVER poll_state_synchronize_rcu_full 0x836d652f
#SYMVER cond_synchronize_rcu 0x49e96999
#SYMVER cond_synchronize_rcu_full 0x1b0602c1
#SYMVER rcu_barrier 0x60a13e90
#SYMVER rcu_exp_jiffies_till_stall_check 0xe9f5116f
#SYMVER rcu_jiffies_till_stall_check 0x3d510a7b
#SYMVER rcu_check_boost_fail 0x8c0ed103
#SYMVER show_rcu_gp_kthreads 0x4f6a07fe
#SYMVER rcu_fwd_progress_check 0x3c1c3725
#SYMVER synchronize_rcu_expedited 0x86f6b99d
#SYMVER start_poll_synchronize_rcu_expedited 0x4c2b351d
#SYMVER start_poll_synchronize_rcu_expedited_full 0x59b063ba
#SYMVER cond_synchronize_rcu_expedited 0xbda04a91
#SYMVER cond_synchronize_rcu_expedited_full 0x8110a73a
#SYMVER rcu_nocb_flush_deferred_wakeup 0x09f50f32
#SYMVER rcu_nocb_cpu_deoffload 0xe791df1f
#SYMVER rcu_nocb_cpu_offload 0x7c3e736a
#SYMVER rcu_bind_current_to_nocb 0x3f83f8d3
#SYMVER rcu_note_context_switch 0x68952493
#SYMVER __rcu_read_lock 0x8d522714
#SYMVER __rcu_read_unlock 0x2469810f
